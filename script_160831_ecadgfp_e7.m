...
FNAME='./Ecadherin-GFP movies/160831 ecadGFPr5 e7 t3-56.tif';
...
for i=1:n
    ...
    temp=imgadapt(:,:,i);
    temp(imgadapt(:,:,i)<1.15*median(reshape(imgadapt(:,:,i),numel(imgadapt(:,:,i)),1)))=0;
...
for i=1:n
    ...
    imgedges(:,:,i)=im2bw(gaborProcess(imgadapt(:,:,i),5,8),level*0.7); %find edges
